<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <h5 class="text-gray-100">
        <marquee scrollamount="15" width="810" height="25" direction="right"> "Selamat Datang Di Coffee Shop Lokal Kami, Rasakan Kenikmatan Yang Berbeda" </marquee>
    </h5>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?= site_url('auth/logout') ?>" data-target="#logoutModal">
